...
bool client::waitForConnection(int& connectionID)
{
    ...
    ::std::cout << "client ready, accepting connections ..." << ::std::endl;
...
bool client::readBody(int csock,google::protobuf::uint32 siz)
{
    int bytecount;
...
bool client::readBody(int csock)
{
    int bytecount;
    kinMsg::request message;
    message.set_endconnection(true);
...
bool client::sendResponse(int csock)
{
